...
public:
    ...
    virtual bool sendMessage(RSKIpcMsg msg, char* payload, unsigned int len) override;
private:
...
bool AgoraVideoSourceIpcImpl::sendMessage( RSKIpcMsg msg, char* payload, unsigned int len)
{
