...
private:
	...
	void getVideoSize(/*agora::rtc::VIDEO_PROFILE_TYPE*/int profile, int& width, int& height);
private:
...
void AgoraVideoSourceTransporter::getVideoSize(int profile, int& width, int& height)
{
 /*   switch (profile) {
